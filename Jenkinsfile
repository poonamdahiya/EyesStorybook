...
pipeline {
    ...
    stages {
        ...
        stage('Build & Test') {
            ...
            post {
                success {
                    curl "https://api.GitHub.com/repos/poonamdahiya/EyesStorybook/statuses/$GIT_COMMIT?access_token=98a551ecd04eeac93a65a672c7567f35667def65" - H "Content-Type: application/json" -X POST -d
