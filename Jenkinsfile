       ...
       stage('Build & Test') {
           ...
           post {
               success {
                   steps {
                       script {
                           sh curl "https://api.GitHub.com/repos/poonamdahiya/EyesStorybook/statuses/$GIT_COMMIT?access_token=1d6b93cb67d0fb7f4b06e891a79b0890116360f4" - H "Content-Type: application/json" -X POST -d
